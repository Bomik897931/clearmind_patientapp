...
abstract class AppLocalizations {
  ...
  /// In en, this message translates to:
  /// **'Let\'s find a doctor'**
  String get letsFindDoctor;

  /// No description provided for @searchSpecialist.
  ///
  /// In en, this message translates to:
  /// **'Search Specialist/City'**
  String get searchSpecialist;
  ...
  /// No description provided for @writeYourSymptoms.
  ///
  /// In en, this message translates to:
  /// **'Write Your Symptoms'**
  String get writeYourSymptoms;
